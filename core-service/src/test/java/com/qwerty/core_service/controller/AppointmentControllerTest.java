...
class AppointmentControllerTest {
    ...
    void getAppointments_ShouldReturnListOfAppointments_WhenDataExists() throws Exception {
        List<Appointment> appointments = List.of(new Appointment(1L, "Проскурин Илья", LocalDate.of(2003, 1, 15), 21, "Ардаков Игорь"));
    ...
    void getAppointment_ShouldReturnAppointment_WhenItExists() throws Exception {
        Appointment appointment = new Appointment(1L, "Синявский Вячеслав", LocalDate.of(1980, 3, 11), 35, "Ардаков Игорь");
    ...
    void addAppointment_ShouldAddAppointment_WhenDataIsValid() throws Exception {
        ...
        Appointment appointment = new Appointment(1L, "Родионов Сергей", LocalDate.of(2005, 10, 10), 19, "Донченко Иван");
    ...
    void updateAppointment_ShouldUpdateAppointment_WhenDataIsValid() throws Exception {
        ...
        Appointment updatedAppointment = new Appointment(1L, "Сыров Дмитрий", LocalDate.of(2001, 9, 11), 23, "Ардаков Игорь");
